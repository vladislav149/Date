...
/* eslint-disable import/extensions */ /* eslint-disable import/no-extraneous-dependencies */ /* eslint-disable no-console */ var _dateFns = require("date-fns");
...
function result(e) {
    e.preventDefault();
    const date = new Date(_constsJsDefault.default.INPUT.value);
    const now = new Date();
    const timeInterval = _dateFns.intervalToDuration({
        start: date,
        end: now
    });
    _viewJsDefault.default(timeInterval);
}
_constsJsDefault.default.FORM.addEventListener('submit', result);

},{"./consts.js":"fWdKl","./view.js":"2GA9o","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","date-fns":"9yHCA"}],"fWdKl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const UI_ELEMENTS = {
    FORM: document.querySelector('.main__form'),
    INPUT: document.querySelector('.main__input'),
    OUTPUT: document.querySelector('.main__output')
};
exports.default = UI_ELEMENTS;
...
var _constsDefault = parcelHelpers.interopDefault(_consts);
function showDate(date) {
    _constsDefault.default.OUTPUT.value = `years: ${date.years},months: ${date.months},hours: ${date.hours},minutes: ${date.minutes}`;
}
exports.default = showDate;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./consts":"fWdKl"}],"9yHCA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../toDate/index.js":"fsust","../differenceInCalendarYears/index.js":"f4WIY","../compareAsc/index.js":"h01l4","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5hNtu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../_lib/toInteger/index.js":"f7kKX","../addMonths/index.js":"hES3W","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aIdiY","bDbGG"], "bDbGG", "parcelRequire2a8f")
